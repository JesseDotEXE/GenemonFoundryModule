...
export class Vendor extends ActorSheetFFGV2 {
    ...
    static get defaultOptions() {
        ...
        mergeObject(options, {
            ...
            template: "modules/genemon/templates/shop/inventory.html",
            width: 710,
            height: 650,
    ...
    get template() {
        return "modules/genemon/templates/shop/inventory.html";
    }

    async getData() {
        const sheetData = super.getData();
        let vendor_data = this.document.getFlag("genemon", "vendor-data");
